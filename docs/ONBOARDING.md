...
- [ ] **3. Viewer** — [VIEWER.md](VIEWER.md) → `varly view --trace … --contract …`
...
```bash
uv run varly verify <file> --contract examples/policies/mvp.yaml --source <air|capture|langgraph|openai>
```
